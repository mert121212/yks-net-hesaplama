...
export default function sitemap(): MetadataRoute.Sitemap {
    ...
    return [
        ...
        {
            url: `${baseUrl}/blog/tyt-matematik-konulari`,
            lastModified: new Date(),
            changeFrequency: 'monthly',
            priority: 0.6,
        },
        {
            url: `${baseUrl}/blog/ayt-matematik-konulari`,
            lastModified: new Date(),
            changeFrequency: 'monthly',
            priority: 0.6,
        },
        {
            url: `${baseUrl}/blog/yks-edebiyat-konulari`,
            lastModified: new Date(),
            changeFrequency: 'monthly',
            priority: 0.6,
        },
        ...
        {
            url: `${baseUrl}/blog/yks-yigilma-tehlikesi`,
            lastModified: new Date(),
            changeFrequency: 'monthly',
            priority: 0.8,
        },
        {
            url: `${baseUrl}/blog/tyt-kesin-cikan-konular`,
            lastModified: new Date(),
            changeFrequency: 'monthly',
            priority: 0.8,
        },
        {
            url: `${baseUrl}/blog/tyt-turkce-paragraf-teknikleri`,
            lastModified: new Date(),
            changeFrequency: 'monthly',
            priority: 0.8,
        },
        {
            url: `${baseUrl}/blog/yks-son-3-ay-calisma-plani`,
            lastModified: new Date(),
            changeFrequency: 'monthly',
            priority: 0.8,
        },
        {
            url: `${baseUrl}/blog/sifirdan-tyt-matematik-calisma-rehberi`,
            lastModified: new Date(),
            changeFrequency: 'monthly',
            priority: 0.8,
        },
