...
export const metadata: Metadata = {
    title: '2026 YKS Sayaç | YKS\'ye Kaç Gün Kaldı? | YKS Ne Zaman',
    ...
    keywords: 'YKS geri sayım, YKS 2026 ne zaman, YKS kaç gün kaldı, TYT geri sayım, AYT geri sayım, YKS tarihi 2026, YKS sayaç',
    alternates: {
