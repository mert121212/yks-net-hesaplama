    ...
    return (
        <>
            <BlogArticleSchema
                ...
                url="https://yksnethesapla.com/blog/yks-net-hesaplama-nasil-yapilir"
                keywords={['yks net hesaplama', 'tyt net hesaplama', 'ayt net hesaplama', 'yks puan hesaplama']}
            />
                            ...
                            <div className="border-t pt-8 mt-12">
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    <Link href="/blog/tyt-net-hesaplama-rehberi" className="p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                                        ...
                                        <p className="text-sm text-gray-700">TYT netlerinizi adım adım hesaplayın</p>
                                    </Link>
                                    <Link href="/blog/ayt-puan-hesaplama" className="p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                                        ...
                                        <p className="text-sm text-gray-700">SAY, EA, SÖZ, DİL puanlarını hesaplayın</p>
                                    </Link>
                                    <Link href="/blog/yks-puan-turleri" className="p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors">
                                        ...
                                        <p className="text-sm text-gray-700">Hangi puan türü size uygun?</p>
                                    </Link>
                                    <Link href="/" className="p-4 bg-orange-50 rounded-lg hover:bg-orange-100 transition-colors">
                                        <p className="font-semibold text-orange-900">Ücretsiz Hesaplama Aracı →</p>
                                        <p className="text-sm text-gray-700">Hemen netlerinizi hesaplayın</p>
                                    </Link>
                                </div>
                            </div>
                        </div>
